...
import { annualVehiclesSales as data } from '../data';
...
class SeriesInteraction extends React.PureComponent {
  constructor(props) {
    super(props);
...
export default withStyles(styles)(SeriesInteraction);
// export default SeriesInteraction;
