...
export default class BalanceSheet extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      'A3': {key: 'A3', value: '33', expr: ''},
      'A4': {key: 'A4', value: '56', expr: ''},
      'B1': {key: 'B1', value: '12121', expr: ''},
      'B2': {key: 'B2', value: '212', expr: ''},
      'B3': {key: 'B3', value: '232', expr: ''},
      'B4': {key: 'B4', value: '233', expr: ''},
      'C1': {key: 'C1', value: '233', expr: ''},
      'C2': {key: 'C2', value: '23', expr: ''},
      'C3': {key: 'C3', value: '343', expr: ''},
      'C4': {key: 'C4', value: '43', expr: ''},
      'D1': {key: 'D1', value: '34', expr: ''},
      'D2': {key: 'D2', value: '34', expr: ''},
      'D3': {key: 'D3', value: '34', expr: ''},
      'D4': {key: 'D4', value: '34', expr: ''}
    }
  }
